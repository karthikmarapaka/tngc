...
<html>
    <head>
        <title>Student Login | TNGC</title>
    ...
    <body class="background" style="overflow-x:hidden;">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="login.php" enctype="multipart/form-data">
                        <div class="form-group">
                            <input type="text" placeholder="Student Mobile Number" name="name" class="form-control" required autocomplete="on">
                            </div>
                        <div class="form-group">
        ...
        if($_SERVER['REQUEST_METHOD']=='POST')
        {
            ...
            $sql ="SELECT s_mobile_no_s,first_name_s FROM student WHERE s_mobile_no_s='$g1'" ;
            if($result=mysqli_query($a,$sql))
            {
            $row=mysqli_fetch_array($result); 
             if($row[0]==$g1 && $g1==$g2)
                 {  $_SESSION['name_sl']=$row[1];
                    $_SESSION['phone_sl']=$row[0];
