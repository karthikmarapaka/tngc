    ...
    <body class="background" style="overflow-x:hidden;">
            ...
            <div class="panel panel-footer">
                ...
                <div class="panel-body">
                    <center><h4 class="text-warning"> 
                        Only Admin can register new member
                    </h4></center>
                    <form method="post" action="sign_up.php" enctype="multipart/form-data" autocomplete="on">
        ...
        if($_SERVER['REQUEST_METHOD']=='POST')
        {
            ...
            $row=mysqli_fetch_array($result); 
             if($row[1]==$g2)
                 {  $_SESSION['name_as']=$row[0];
                    $_SESSION['phone_as']=$row[2];
                  
                 echo "<script type='text/javascript'>window.location.href = 'sign_up_input.php';</script>";
                 }
                else
                        {
